  ...
  return (function (e) {
    ...
    function (e, n, t) {
      ...
      function o(e) {
        ...
        if (
          (4 == e.length && (e = e.replace(/[a-fA-F\d]/g, "$&$&")),
          7 == e.length)
        )
          return e;
        ...
        return (
          (n[3] = (n[3] / 255).toPrecision(2)), "rgba(" + n.join(", ") + ")"
        );
      }
      var a = [
        ...
        n.settings.forEach((e) => {
          if (e.settings) {
            ...
            var t = {},
              r = e.settings;
            r.foreground &&
              (t.foreground = o(r.foreground).toLowerCase().replace("#", "")),
              r.background &&
                (t.background = o(r.background).toLowerCase().replace("#", "")),
              r.fontStyle &&
                "string" == typeof r.fontStyle &&
          ...
          if (63 !== D)
            if (33 !== D) {
              ...
              var G =
                ...
                (H = f(">")),
                (x = !1),
                47 === H.charCodeAt(H.length - 1) &&
                  ((x = !0), (H = H.substring(0, H.length - 1))),
              ...
              switch (G.name) {
                case "dict":
                  1 === d
                    ...
                    ? w.enterDict()
                    : ((h = {}),
                      null !== t && (h[t] = { filename: n, line: o, char: a }),
                      v(1, h)),
                    G.isClosed && S();
                  continue;
                case "array":
